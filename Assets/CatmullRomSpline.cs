...
public class CatmullRomSpline : MonoBehaviour
{
	...
	public Vector3 GetSplinePosition(float ratio) //ratio 0 ~ 1
	{
		float totalCount = controlPointsList.Length;
		int pos = (int)(ratio * totalCount);
		float t = ratio * totalCount - pos;
